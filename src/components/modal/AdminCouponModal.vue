            ...
            <VForm v-slot="{ meta }" @submit="confirmUpdate" ref="form">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <VField
                                ...
                                name="percent" rules="required|integer|min_value:1|max_value:100">
                            </VField>
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            id="due_date" type="date" class="form-control"
                ...
                <div class="modal-footer justify-content-between align-items-center">
                    <div class="form-check">
                        <input
                            id="is_enabled" type="checkbox" class="form-check-input"
                            v-model="coupon.is_enabled" :true-value="1" :false-value="0">
                        <label class="form-label" for="is_enabled">是否啟用</label>
                    </div>
                    <div>
                        <button type="submit" class="btn btn-primary me-2" :disabled="!meta.valid">
                        確認更新</button>
