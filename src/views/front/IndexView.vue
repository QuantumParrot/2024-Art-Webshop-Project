                    ...
                    <div
                        ...
                        <div class="d-flex justify-content-lg-center align-items-center
                            ...
                            <div class="lh-lg">
                                ...
                                <span class="section-title">豐富藏品，形塑風格</span></h3>
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="intro-sec shadow-sm rounded-1 p-2">
                        <div class="d-flex justify-content-lg-center align-items-center
                            ...
                            <div class="lh-lg">
                                <h3 class="fw-bold mb-6">
                                <span class="section-title">共享見聞，拓展視野</span></h3>
                                <p>我們不止步於純粹的電商經營</p>
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="intro-sec shadow-sm rounded-1 p-2">
                        <div class="d-flex justify-content-lg-center align-items-center
                            ...
                            <div class="lh-lg">
                                <h3 class="fw-bold mb-6">
                                <span class="section-title">回饋社會，實踐永續</span></h3>
