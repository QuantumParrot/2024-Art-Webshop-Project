    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button
                    type="button" class="btn border-0 p-0 fs-4" :disabled="!!loadingTask"
                    @click="hideModal">
            ...
            <div class="modal-body py-4">
                ...
                <div v-show="tab === 'info'">
                    <p>
                        ...
                        <span>{{ $calc.formatTime(tempOrder.create_at * 1000) }}</span>
                    </p>
                    <hr>
                    <p>
                    ...
                    <hr>
                    <p>
                        <span class="badge bg-primary">地址</span>
                    </p>
                    <p>{{ tempOrder.user.address }}</p>
                    <hr>
                    <p>
                        <span class="badge bg-primary">信箱</span>
                    </p>
                    <p>{{ tempOrder.user.email }}</p>
                    <hr>
                    <p>
                        <span class="badge bg-primary">贊助計畫</span>
                    </p>
                    <p>{{ tempOrder.project }}</p>
                    <hr>
                    <p>
                        <span class="badge bg-primary">留言</span>
                    </p>
            ...
            <div class="modal-footer" v-if="tempOrder.is_paid && tempOrder.state !== 4">
                <div class="alert bg-gray d-flex align-items-center gap-3 text-nowrap mb-0">
                    <div class="d-flex align-items-center">
                        <div
                            v-if="loadingTask === tempOrder.id"
                            class="spinner-border text-primary me-3" role="status">
                        </div>
                        <span>修改訂單狀態</span>
                    </div>
                    <select
                        class="form-select" :value="tempOrder.state" @change="preUpdate"
